...
//        Employee emp1 = new HourlyPlusIncentiveEmployee(10.50, 2020);
        Employee emp1 = new HourlyEmployee(10.00,2020);
        Employee emp2 = new SalariedEmployee(45000, 1250);
        Employee emp3 = new SalariedEmployee(90000,0);
        Employee emp4 = new HourlyPlusIncentiveEmployee(10.00,2020);
        ...
        double annualWages = hr.getAnnualCompensationForEmployee(emp2);
